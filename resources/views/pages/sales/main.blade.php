                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 text-right">
                                <input type="text" class="form-control" id="employee" value="{{ Auth::user()->username }}" readonly/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control">
                                    <option value="1">Mark Heramis</option>
                                    <option value="2">Czarina C</option>
                                    <option value="3">Brian Ernas</option>
                                </select>
                            </div>
                        </div>
